            ...
            <section class="weather-hourly">
                <ul class="weather-hourly__list">
                    <li class="weather-item" v-for="(item, key) in forecast.hourly">
                        ...
                        <span class="weather-item__temps">{{ item.temperature.toFixed(0) }}ºC <span class="weather-item__temps__fl" v-if="item.temperature != item.apparentTemperature">F/L {{ item.apparentTemperature.toFixed(0) }}ºC</span></span>
                    </li>
                </ul>
            </section>
